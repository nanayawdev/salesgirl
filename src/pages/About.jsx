      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-2xl font-bold text-secondary dark:text-white mb-4">
              About Salesgirl
            </h1>
          ...
          <div className="space-y-8">
            {/* Mission Section */}
            <section className="bg-white dark:bg-secondary/50 p-6 rounded-lg shadow-lg border border-accent/10">
              <h2 className="text-xl font-semibold text-primary dark:text-accent mb-4">
                Our Mission
              </h2>
              <p className="mb-4 text-base text-secondary dark:text-gray-300">
            ...
            <section className="bg-white dark:bg-secondary/50 p-6 rounded-lg shadow-lg border border-accent/10">
              ...
              <ul className="list-disc list-inside space-y-2 text-base text-secondary dark:text-gray-300">
