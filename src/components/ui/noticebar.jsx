...
const NoticeBar = () => {
  return (
    <a
      href="/status"
      className="hidden tablet:flex items-center rounded-full bg-algaeGreen-400 dark:bg-algaeGreen-500 px-3 py-1 hover:bg-algaeGreen-600 dark:hover:bg-algaeGreen-300 transition-colors cursor-pointer"
    >
