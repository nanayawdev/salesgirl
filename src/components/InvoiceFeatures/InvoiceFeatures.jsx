    ...
    <div className="px-4 py-12 sm:py-16 lg:py-20 bg-background-light dark:bg-background-dark">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          <div className="group p-4 sm:p-6 rounded-2xl bg-codGray-50 dark:bg-codGray-950 transition-all duration-300 border border-codGray-100 dark:border-codGray-950 hover:border-algaeGreen-100 dark:hover:border-algaeGreen-100 hover:-translate-y-1">
