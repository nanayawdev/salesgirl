    ...
    <div className="py-24 bg-black">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          {/* Background Line */}
          <div className="absolute top-24 left-0 w-full h-0.5 bg-gray-800 hidden md:block" />
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="flex flex-col items-start">
                  {/* Number */}
                  <span className="text-4xl font-bold text-gray-800 dark:text-gray-700 mb-8 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-violet-500 transition-all duration-300">
                    {step.number}
                  </span>
